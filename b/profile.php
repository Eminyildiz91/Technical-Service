...
$email = htmlspecialchars($_SESSION['email']); // E-posta oturumdan alınır
?>
        ...
        <div class="mb-npx">
          <div class="row align-items-center">
            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
              <!-- Title -->
              <h1 class="h2 mb-0 ls-tight">Hesap Ayarları</h1>
            </div>
            <!-- Actions -->
          ...
          <ul class="nav nav-tabs mt-4 overflow-x border-0">
            ...
            <li class="nav-item">
              <a href="version.php" class="nav-link font-regular">Version</a>
            </li>
          </ul>
        </div>
      </div>
          ...
          <div class="col-xl-7 mx-auto">
                ...
                <div class="d-flex align-items-center">
                  <div>
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-4">
                        <span class="h4 d-block mb-0"> <?php echo $name; ?> <br> <?php echo $email; ?> </span>
                        <a href="#" class="text-sm font-semibold text-muted">Fotograf Yükle</a>
                      </div>
                    </div>
                  </div>
                  <div class="ms-auto">
                    <button type="button" class="btn btn-sm btn-neutral">Yükle</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <form class="mb-6">
              ...
              <div class="row g-5">
                ...
                <div class="col-md-2">
                  <div class="">
                    <label class="form-label" for="zip">Posta Kodu</label>
              ...
              <div class="text-end">
                <button type="button" class="btn btn-sm btn-neutral me-2">İptal et</button>
