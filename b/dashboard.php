      ...
      <div class="collapse navbar-collapse" id="sidebarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <i class="bi bi-files"></i>Yeni Servis Kaydi
            </a>
          </li>
          <li class="nav-item">
        ...
        <div class="mb-npx">
          <div class="row align-items-center">
            <div class="col-sm-6 col-12 mb-4 mb-sm-0">
              <!-- Title -->
              <h1 class="h2 mb-0 ls-tight">Anasayfa</h1> 
      ...
      <div class="container-fluid">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="mt-2 mb-0 text-sm">
                  ...
                  <span class="text-nowrap text-xs text-muted">Geçen aydan beri</span>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <span class="h6 font-semibold text-muted text-sm d-block mb-2">Kullanıcılar</span>
                    <span class="h3 font-bold mb-0">0</span>
                  </div>
                  <div class="col-auto">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <span class="h6 font-semibold text-muted text-sm d-block mb-2">Toplam Saat</span>
                    <span class="h3 font-bold mb-0">0</span>
                  </div>
                  <div class="col-auto">
          ...
          <div class="col-xl-3 col-sm-6 col-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col">
                    <span class="h6 font-semibold text-muted text-sm d-block mb-2">İş Yükü</span>
                    <span class="h3 font-bold mb-0">0%</span>
                  </div>
                  <div class="col-auto">
        ...
        <div class="card mb-7">
          <div class="card-header">
            <h5 class="mb-0"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
...
Takip No</h5>
            ...
            <table class="table table-hover table-nowrap">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <span class="badge badge-lg badge-dot">
                      <i class="bg-success"></i>Planlanmış
                    </span>
                  ...
                  <td>
                    ...
                    <span class="badge badge-lg badge-dot">
                      <i class="bg-dark"></i>Servis Numarası:
                    </span>
                  </td>
                  <td class="text-end">
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge badge-lg badge-dot">
                      <i class="bg-warning"></i>Ertelendi
                    </span>
                  </td>
                  <td>
               ...
               <button type="button" class="btn btn-sm btn-square btn-neutral text-danger-hover">
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge badge-lg badge-dot">
                      <i class="bg-dark"></i>Tartışılmadı
                    </span>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge badge-lg badge-dot">
                      <i class="bg-danger"></i>Iptal Edildi
                    </span>
                  </td>
                  <td>
          ...
          <div class="card-footer border-0 py-5">
            <span class="text-muted text-sm">Bulunan 10 sonuçtan 10 tanesi gösteriliyor</span>
          </div>
        </div>
      </div>
    </main>
